...
void InitLogging(const char* log_prefix, LoggingDestination logging_dest,
                 LogLockingState lock_log, OldFileDeletionState delete_old);

inline void InitLogging(const char* log_prefix, LogLockingState lock_log) {
  return InitLogging(log_prefix,
             LOG_ONLY_TO_FILE, lock_log, APPEND_TO_OLD_LOG_FILE);
}
#endif
...
#define COMPACT_GOOGLE_LOG_INFO \
  logging::LogMessage(__FILE__, __LINE__, __FUNCTION__, logging::LOG_INFO)
#define COMPACT_GOOGLE_LOG_WARNING \
  logging::LogMessage(__FILE__, __LINE__, __FUNCTION__, logging::LOG_WARNING)
#define COMPACT_GOOGLE_LOG_ERROR \
  logging::LogMessage(__FILE__, __LINE__, __FUNCTION__, logging::LOG_ERROR)
#define COMPACT_GOOGLE_LOG_ERROR_REPORT \
  logging::LogMessage(__FILE__, __LINE__, __FUNCTION__, logging::LOG_ERROR_REPORT)
#define COMPACT_GOOGLE_LOG_FATAL \
  logging::LogMessage(__FILE__, __LINE__, __FUNCTION__, logging::LOG_FATAL)
#define COMPACT_GOOGLE_LOG_DFATAL \
  logging::LogMessage(__FILE__, __LINE__, __FUNCTION__, logging::LOG_DFATAL_LEVEL)
