...
static int64_t processed_bytes = 0;
static int64_t used_time_ns = 0;
static int64_t begin_time_ns = 0;
static int64_t processed_items = 0;
...
void StopBenchmarkTiming() {
    if (begin_time_ns != 0)
        used_time_ns += GetTimeInNs() - begin_time_ns;
    begin_time_ns = 0;
}

void StartBenchmarkTiming() {
    if (begin_time_ns == 0)
        begin_time_ns = GetTimeInNs();
}
