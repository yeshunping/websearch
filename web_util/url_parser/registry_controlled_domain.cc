...
// NOTE(shunpingye): port from chrome,
//  fake CanonicalizeHost to replace net::CanonicalizeHost
...
#include "thirdparty/googleurl/url_parse.h"

#include "web_util/url_parser/effective_tld_names.cc"

namespace net {
string CanonicalizeHost(const std::string& host,
...
string CanonicalizeHost(const std::wstring& host,
                        url_canon::CanonHostInfo* host_info) {
