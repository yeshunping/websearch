...
#include <stdarg.h>
#include <locale.h>
#include "thirdparty/svm/liblinear/linear.h"
#include "thirdparty/svm/liblinear/tron.h"
...
model* train(const problem *prob, const parameter *param)
{
	...
	else
	{
		...
		for(i=0;i<param->nr_weight;i++)
		{
			...
			info("weighted_C[j]:%f", weighted_C[j]);
		}
