...
{
	_easou_css_prop_type_t type; /* 属性类型  */
...
{
	easou_css_attr_selector_type_t type; /* 属性选择子类型  */
	html_attribute_t attr; /* 属性/值  */
	struct _easou_css_attr_selector_t *next; /* 下一个属性选择子  */
...
typedef struct _easou_css_simple_selector_t
{
	...
	easou_css_attr_selector_t *attr_selector; /**< 属性选择子  */
	easou_css_class_selector_t class_selector; /**< CLASS选择子  */
	easou_css_id_selector_t id_selector; /**<  ID选择子 */
	easou_css_pseudo_selector_t pseudo_selector; /**< 伪类选择子  */
...
{
	struct _easou_css_selector_t *pre_selector; /**< 前选择子  */
	easou_css_selector_combinator_t combinator; /**< 组合符号 */
	easou_css_simple_selector_t simple_selector; /**< 简单选择子  */
...
{
	int id;
	easou_css_selector_t *selector; /**< 选择子  */
	easou_css_property_t *all_property_list; /**< 所有属性列表  */
	easou_css_property_t *font_prop_begin, *font_prop_end; /**< 字体属性的开始和结尾指针  */
	easou_css_property_t *geo_prop_begin, *geo_prop_end; /**< 几何属性的开始和结尾指针  */
	easou_css_property_t *other_prop_begin, *other_prop_end; /**< 其他属性的开始和结尾指针  */
	struct _easou_css_ruleset_t *next; /**< 在CSS结构上的下一个规则集  */
	struct _easou_css_ruleset_t *index_next; /**< 在索引上的下一个规则集  */
} easou_css_ruleset_t;
...
{
	easou_css_mem_node_t *mem_node_list; /**< 已分配的内存链  */
...
{
	easou_css_str_heap_t str_heap; /**< 字符串堆结构  */
	easou_css_nodepool_t nodepool; /**< 节点池  */
} easou_css_inner_t;
...
{
	easou_css_index_node_t *type_index[TAG_TYPE_NUM_LIMIT]; /**< 每个TAG类型对应一个索引  */
	hashmap_t *class_map;
} easou_css_index_t;
...
{
	easou_css_inner_t css_inner; /**< CSS内部结构,用于内存管理  */
	easou_css_ruleset_t *all_ruleset_list; /**< 所有规则集列表  */
	easou_css_index_t index; /**< CSS索引结构  */
} easou_css_t;
...
typedef struct _easou_css_scan_t
{
	...
	const char *p_next; /**<   */
	easou_css_token_type_t type; /**< 当前正在扫描的字符类型  */
	easou_css_state_t state; /**< 当前正在扫描的css类型  */
